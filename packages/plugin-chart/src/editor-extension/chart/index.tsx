...
必须提供 chartConfig 参数，包含 type、data、dataKeys 等信息。`,
            inputSchema: z.object({
                chartConfig: z.object({
                    type: z.enum(['bar', 'line', 'area', 'pie', 'radar', 'radialBar', 'scatter']).describe("图表类型"),
                    ...
                    colors: z.record(z.string(), z.string()).describe("颜色映射，key 为 dataKey，value 为 CSS 颜色值").optional(),
            ...
            execute: (editor: Editor) => async (params: {
                ...
                try {
                    const { chartConfig, position } = params;
                    ...
                    if (position !== undefined) {
                        ...
                        editor.commands.insertChart(chartConfig);
                    }
        ...
        // Tool 3: Update Chart
        {
            ...
            inputSchema: z.object({
                ...
                chartConfig: z.object({
                    type: z.enum(['bar', 'line', 'area', 'pie', 'radar', 'radialBar', 'scatter']).describe("图表类型").optional(),
                    title: z.string().describe("图表标题").optional(),
                    description: z.string().describe("图表描述").optional(),
                    ...
                    colors: z.record(z.string(), z.string()).describe("颜色映射").optional(),
                    showLegend: z.boolean().describe("是否显示图例").optional(),
                    showGrid: z.boolean().describe("是否显示网格线").optional(),
                    showDataLabels: z.boolean().describe("是否显示数据标签").optional(),
        ...
        // Tool 5: Get Chart Templates
        {
            ...
            inputSchema: z.object({
                chartType: z.enum([
                    'bar', 'line', 'area', 'pie', 'radar', 'radialBar', 'scatter', 'all'
