    ...
    "zh": {
      translation: {
        ...
        "template": {
          ...
          "cover": "封面",
          "coverAutoHint": "未上传封面时，将根据模板标题和页面摘要自动生成。",
          "coverEmptySummary": "可重复使用的知识模板",
          "coverFallbackSaved": "模板已保存，但自动封面生成失败，将使用默认封面",
          "description": "描述",
        ...
        "members": {
          ...
          "invite": "邀请",
          "inviteTitle": "邀请成员",
          "inviteDesc": "从组织添加成员，或按姓名/邮箱搜索后邀请加入此空间。",
          "add": "添加",
          "allRoles": "全部角色",
          "cancel": "取消",
          "empty": "暂无成员",
          ...
          "sourceOrganization": "从组织添加",
          "sourceSearch": "搜索全部用户",
          "orgSearchPlaceholder": "筛选组织成员...",
          "noOrgCandidates": "组织内成员都已在此空间中",
          "noResults": "未找到用户",
          "noMatch": "没有匹配的成员",
          "invited": "成员邀请成功",
          "inviteError": "邀请成员失败",
    ...
    "en": {
      translation: {
        ...
        "template": {
          ...
          "cover": "Cover",
          "coverAutoHint": "A cover will be generated from the template title and page summary when no image is uploaded.",
          "coverEmptySummary": "A reusable knowledge template",
          "coverFallbackSaved": "Template saved, but the automatic cover could not be generated; the default cover will be used",
        ...
        "members": {
          ...
          "inviteDesc": "Add people from your organization, or search all users to invite them to this space.",
          "add": "Add",
          "allRoles": "All roles",
          "cancel": "Cancel",
          ...
          "sourceOrganization": "From organization",
          "sourceSearch": "Search all users",
          "orgSearchPlaceholder": "Filter organization members...",
          "noOrgCandidates": "Everyone in the organization is already a member",
