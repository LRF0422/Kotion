...
export const translations = {
    en: {
        ...
        preview: {
            ...
            identifyingMedia: 'Identifying media…',
            ...
            retry: 'Retry',
            mediaIdentificationFailed: 'This media file could not be identified.',
            mediaLoadFailed: 'This media file could not be loaded.',
            loadingText: 'Loading file…',
            textLoadFailed: 'Failed to load the file content.',
            binaryFile: 'This file contains binary data and cannot be shown as text.',
            textTruncated: 'Preview limited to the first 2 MB — download the file to see the rest.',
            copy: 'Copy',
            copied: 'Copied',
            unsupportedVideoCodec: 'This video uses a codec that your browser cannot play.',
            playbackFailed: 'Playback could not start.',
            downloadFallback: 'Try again or download the file to play it locally.',
        },
        confirm: {
    ...
    zh: {
        ...
        preview: {
            ...
            exitFullscreen: '退出全屏',
            retry: '重试',
            mediaIdentificationFailed: '无法识别此媒体文件。',
            mediaLoadFailed: '无法加载此媒体文件。',
            loadingText: '正在加载文件…',
            textLoadFailed: '文件内容加载失败。',
            binaryFile: '该文件包含二进制内容，无法以文本方式预览。',
            textTruncated: '仅预览前 2 MB 内容，下载文件可查看完整内容。',
            copy: '复制',
            copied: '已复制',
            unsupportedVideoCodec: '此视频使用了当前浏览器无法播放的编码格式。',
            playbackFailed: '无法开始播放。',
            downloadFallback: '请重试，或下载文件后在本地播放。',
        },
        confirm: {
