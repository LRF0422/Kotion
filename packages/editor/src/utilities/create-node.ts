...
export function insertNewLine() {
  return function (state: { selection: { $from: any; }; schema: { nodes: { hardBreak: any; }; }; tr: { replaceSelectionWith: (arg0: any, arg1: boolean) => any; insertText: (arg0: string) => any; }; }, dispatch: (arg0: any) => void) {
...
export function createParagraphAtEnd() {
  return function (state: { tr: any; }, dispatch: (arg0: any) => void) {
    const { tr } = state;
