...
export const StyledEditor = styled.div.attrs({
  className: 'prose prose-headings:dark:text-white prose-li:dark:text-white prose-a:dark:text-white prose-code:dark:text-white prose-p:dark:text-white prose-img:m-0 max-w-none px-[180px]'
})`
