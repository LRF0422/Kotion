    ...
    translation: {
      ...
      uploadTasks: {
        ...
        status: {
          ...
          NEEDS_PERMISSION: "需要文件权限",
          NEEDS_RESELECT: "需要重新选择文件",
          FINALIZING: "正在完成",
          COMPLETED: "上传完成",
          FAILED: "上传失败",
          CANCELLING: "正在取消",
      ...
      desktopCapture: {
        ...
        screenshotTab: "截图",
        regionTab: "区域截图",
        regionHint: "拖动选择区域，Esc 取消",
        recordingTab: "录屏",
        loadingSources: "加载来源…",
        noSources: "没有可捕捉的屏幕或窗口。",
        noPreview: "无预览",
        desktopOnly: "该功能仅在桌面客户端可用。",
        recordingHint: "正在录制，停止后会保存到文件中心",
        stopAndSave: "停止并保存",
        discard: "放弃",
        saved: "已保存到文件中心：{{name}}",
        permissionDenied: "无法获取屏幕来源（屏幕录制权限：{{status}}）。请在「系统设置 → 隐私与安全性 → 屏幕录制」中勾选本应用，然后重启应用。",
        canvasUnavailable: "无法创建画布上下文",
        encodeFailed: "截图编码失败",
        captureFailed: "截图失败",
        recordFailed: "录屏失败",
      },
      ...
      editor: {
        ...
        columns: {
          ...
          customColorPlaceholder: "自定义颜色（#hex / rgb() / var(--x)）",
          width: "当前列 · 宽度 (%)",
      ...
      ai: {
        ...
        modelSelector: {
          ...
          empty: "暂无可用模型",
          visionBadge: "识图",
          visionBadgeHint: "该模型支持图片输入，可直接识别图片内容",
        },
        modelParams: {
          title: "模型参数",
          reset: "重置",
        ...
        chat: {
          ...
          stopGeneration: "停止生成",
          send: "发送消息",
          attachImage: "上传图片（模型可直接查看）",
          attachImageBlocked: "当前模型「{{model}}」不支持图片识图，请先切换到支持识图的模型",
          removeImage: "移除图片",
          thisModel: "当前模型",
          visionUnsupportedError: "当前模型「{{model}}」不支持图片输入，图片未添加。请切换到支持识图的模型。",
          visionUnsupportedWarning: "当前模型「{{model}}」不支持图片输入，这些图片不会发送给模型。请切换到支持识图的模型，或移除图片后再发送。",
          loadingModels: "加载模型中…",
      ...
      settings: {
        ...
        profile: {
          ...
          desc: "用于内容推荐的低敏感用户特征",
          privacyNotice:
            "画像由你的 AI 会话派生，仅包含职业、兴趣、偏好等低敏感特征，不推断性别、精神状态或性格。你可以随时查看、编辑、删除或关闭。",
          consentTitle: "开启画像",
          consentDesc: "开启后才会从你的 AI 会话中派生特征；关闭会立即清空全部画像数据。",
          consentOn: "已开启画像",
          consentOff: "已关闭画像并清空数据",
          loadFailed: "读取画像失败",
          saveFailed: "操作失败，请重试",
          empty: "暂无画像特征。开启后会在你使用 AI 时逐步生成，也可以手动添加。",
          addTitle: "手动添加",
          addDesc: "手动添加的特征会被锁定，不会被自动推断覆盖。",
          valuePlaceholder: "例如：后端工程师",
          add: "添加",
          save: "保存",
          cancel: "取消",
          edit: "编辑",
          ...
          evidenceEmpty: "暂无依据",
          reset: "清空全部画像",
          resetConfirm: "确定清空全部画像与依据吗？此操作不可撤销。",
          resetDone: "已清空画像",
          sourceInferred: "自动推断",
          sourceUser: "我的设定",
          confidence: "置信度",
        ...
        agents: {
          title: "自定义 Agent",
          desc: "配置自己的 Agent：起个名字、写好指引，会话时即可切换",
          create: "新建 Agent",
          createTitle: "新建 Agent",
          editTitle: "编辑 Agent",
          dialogDesc: "名称用于在选择器中显示，指引会附加到该 Agent 的系统提示。",
          emoji: "图标",
          name: "名称",
          namePlaceholder: "例如：严谨的学术编辑",
          description: "简介（可选）",
          descriptionPlaceholder: "一句话说明这个 Agent 擅长什么",
          instructions: "自定义指引",
          instructionsPlaceholder: "你是一名……回答时请……始终……",
          instructionsHint: "指引会附加到系统提示末尾，不会覆盖文档安全等关键规则。",
          instructionsEmptyHint: "写一段指引，用来规定这个 Agent 的行为与风格。",
          addInstructions: "添加指引",
          personalizeTitle: "个性化你的 Agent",
          prevEmoji: "上一个头像",
          nextEmoji: "下一个头像",
          reset: "重置",
          done: "完成",
          ...
          emptyDesc: "创建一个带名称和指引的 Agent，会话时就能选择它",
          inUse: "使用中",
          selected: "已选择",
          use: "使用",
          edit: "编辑",
          delete: "删除",
          confirmDelete: "确认删除",
          currentHint: "当前会话使用「{{name}}」，可在对话中随时切换。",
          saveError: "保存失败，已暂存到本地：{{error}}",
          cancel: "取消",
          save: "保存",
          nameRequired: "请填写 Agent 名称",
          instructionsRequired: "请填写 Agent 指引",
          saved: "Agent 已保存",
          deleted: "Agent 已删除",
          default: "默认 Agent",
          pick: "选择 Agent",
  ...
  en: {
    translation: {
      ...
      appMenu: {
        ...
        download: "Download",
        quit: "Quit",
        toggleDevTools: "Open developer tools",
        website: "Website",
        changelog: "Changelog",
        webVersion: "Web",
      },
      ...
      uploadTasks: {
        ...
        status: {
          QUEUED: "Queued",
          CHECKSUMMING: "Checking",
          UPLOADING: "Uploading",
          PAUSED: "Paused",
          WAITING_FOR_NETWORK: "Waiting for network",
          NEEDS_PERMISSION: "Permission required",
          NEEDS_RESELECT: "File re-selection required",
      ...
      desktopCapture: {
        ...
        regionTab: "Region",
        regionHint: "Drag to select a region, Esc to cancel",
        recordingTab: "Recording",
        loadingSources: "Loading sources…",
        noSources: "No screens or windows to capture.",
        noPreview: "No preview",
        desktopOnly: "This feature is only available in the desktop app.",
        recordingHint: "Recording. It is saved to the file center when stopped.",
        stopAndSave: "Stop and save",
        discard: "Discard",
        saved: "Saved to the file center: {{name}}",
        permissionDenied: "Cannot read screen sources (screen recording permission: {{status}}). Enable this app under System Settings → Privacy & Security → Screen Recording, then restart the app.",
        canvasUnavailable: "Could not create a canvas context",
        encodeFailed: "Failed to encode the screenshot",
      ...
      editor: {
        ...
        columns: {
          ...
          gap: "Column gap",
          padding: "Current column · Padding",
          paddingOptions: {
            none: "None",
            compact: "Compact",
            medium: "Medium",
          ...
          verticalAlign: "Current column · Vertical alignment",
          verticalAlignOptions: {
            top: "Top",
            center: "Center",
            bottom: "Bottom",
          },
          border: "Current column · Show border",
          backgroundLabel: "Current column · Background",
          background: {
            none: "None",
            gray: "Soft gray",
            blue: "Light blue",
          ...
          customColorPlaceholder: "Custom color (#hex / rgb() / var(--x))",
      ...
      ai: {
        ...
        modelSelector: {
          ...
          visionBadge: "Vision",
          visionBadgeHint: "This model accepts image input and can read images directly",
        },
        modelParams: {
        ...
        chat: {
          ...
          send: "Send message",
          attachImage: "Attach image (the model can view it)",
          attachImageBlocked: "Model \"{{model}}\" cannot read images — switch to a vision-capable model first",
          removeImage: "Remove image",
          thisModel: "the current model",
          visionUnsupportedError: "Model \"{{model}}\" does not accept image input, so the image was not attached. Switch to a vision-capable model.",
          visionUnsupportedWarning: "Model \"{{model}}\" does not accept image input, so these images will not be sent. Switch to a vision-capable model, or remove them before sending.",
          ...
          toolFailed: "Failed",
          toolDetails: "View call details",
          toolInput: "Input",
          toolOutput: "Output",
          toolError: "Error details",
          preparingAnswer: "Working…",
          ...
          errors: {
            ...
            server: "The server encountered an error. Try again shortly.",
            unknown: "Generation failed. Try again.",
          },
        },
        agent: {
      ...
      settings: {
        ...
        profile: {
          title: "My Profile",
          desc: "Low-sensitivity traits used for content recommendations",
          privacyNotice:
            "Your profile is derived from your AI conversations and only contains low-sensitivity traits such as occupation, interests and preferences. Gender, mental state and personality are never inferred. You can view, edit, delete or disable it at any time.",
          consentTitle: "Enable profile",
          consentDesc:
            "Traits are derived only while this is on; turning it off immediately purges every derived row.",
          consentOn: "Profile enabled",
          consentOff: "Profile disabled and data purged",
          loadFailed: "Failed to load profile",
          saveFailed: "Action failed, please retry",
          empty:
            "No traits yet. Once enabled they accumulate as you use the AI; you can also add them manually.",
          addTitle: "Add manually",
          addDesc: "Manually added traits are locked and never overwritten by inference.",
          valuePlaceholder: "e.g. Backend Engineer",
          add: "Add",
          save: "Save",
          cancel: "Cancel",
          edit: "Edit",
          ...
          reset: "Purge all profile data",
          resetConfirm: "Purge all traits and evidence? This cannot be undone.",
          resetDone: "Profile purged",
        ...
        agents: {
          title: "Custom Agents",
          desc: "Configure your own agents: name them, write guidance, and switch between them while chatting",
          create: "New agent",
          createTitle: "New agent",
          editTitle: "Edit agent",
          dialogDesc: "The name is shown in the picker; the guidance is appended to this agent's system prompt.",
          emoji: "Icon",
          name: "Name",
          namePlaceholder: "e.g. Rigorous academic editor",
          description: "Description (optional)",
          descriptionPlaceholder: "One line about what this agent is good at",
          instructions: "Custom guidance",
          instructionsPlaceholder: "You are a... When answering, always...",
          instructionsHint: "The guidance is appended to the system prompt and never overrides document-safety rules.",
          instructionsEmptyHint: "Write guidance to shape this agent's behavior and voice.",
          addInstructions: "Add instructions",
          personalizeTitle: "Personalize your agent",
          prevEmoji: "Previous avatar",
          nextEmoji: "Next avatar",
          reset: "Reset",
          done: "Done",
          profession: {
            engineer: "Engineer",
          ...
          emptyDesc: "Create an agent with a name and guidance, then pick it while chatting",
          inUse: "In use",
          selected: "Selected",
          use: "Use",
          edit: "Edit",
          ...
          currentHint: "This conversation uses '{{name}}'; you can switch anytime while chatting.",
          saveError: "Save failed, kept locally: {{error}}",
          cancel: "Cancel",
          save: "Save",
          nameRequired: "Please enter an agent name",
          instructionsRequired: "Please enter the agent guidance",
          saved: "Agent saved",
