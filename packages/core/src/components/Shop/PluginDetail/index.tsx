...
export const PluginDetail: React.FC = () => {
    ...
    return <div className="flex flex-col w-full justify-center">
        <div className="flex gap-10 items-center justify-center mt-10 shadow-sm border-b mb-10">
        ...
        <div className=" w-full bg-muted/60 flex justify-center h-[calc(100vh-100px)]">
            <Tabs className="mt-5 w-[80%] " defaultValue="Feature">
                <TabsList>
                    <TabsTrigger value="Feature">Feature</TabsTrigger>
                    <TabsTrigger value="Detail">Detail</TabsTrigger>
                    <TabsTrigger value="ChangeLog">ChangeLog</TabsTrigger>
                </TabsList>
                <TabsContent value="Feature" className="h-full overflow-auto border rounded-sm">
                    <EditorRender
                        id="Feature"
                        toc={false}
                        toolbar={false}
