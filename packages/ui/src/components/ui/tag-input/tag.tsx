...
export const tagVariants = cva('transition-all border inline-flex items-center text-sm pl-2 rounded-md', {
    variants: {
        variant: {
            ...
            primary:
                'bg-primary border-primary text-primary-foreground hover:bg-primary/90  disabled:opacity-50',
            destructive:
                'bg-destructive border-destructive text-destructive-foreground hover:bg-destructive/90 disabled:opacity-50',
        },
        size: {
            xs: 'text-xs h-5',
            sm: 'text-xs h-7',
