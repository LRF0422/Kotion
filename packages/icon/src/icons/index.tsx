...
export const IconDrag: ElementType = buildIcon(
...
export const IconBlockquote: ElementType = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 24 24">
    <path fill="none" d="M0 0h24v24H0z" />
...
export const IconBilibili = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 1024 1024">
    <path d="M717.257 277.376c-40.192 0-76.544 18.688-99.968 48.512-23.424-29.824-59.84-48.512-99.968-48.512-69.76 0-126.272 56.512-126.272 126.272v222.848c0 69.696 56.512 126.272 126.272 126.272 40.128 0 76.544-18.688 99.968-48.512 23.424 29.824 59.84 48.512 99.968 48.512 69.76 0 126.272-56.512 126.272-126.272V403.648c0-69.76-56.512-126.272-126.272-126.272zM464.704 325.888c29.824 0 54.848 25.088 54.848 54.848v174.336c0 29.76-25.024 54.848-54.848 54.848-29.76 0-54.848-25.088-54.848-54.848V380.736c0-29.76 25.088-54.848 54.848-54.848zm252.544 0c29.824 0 54.848 25.088 54.848 54.848v174.336c0 29.76-25.024 54.848-54.848 54.848-29.76 0-54.848-25.088-54.848-54.848V380.736c0-29.76 25.088-54.848 54.848-54.848z" />
  </svg>
);
...
export const IconThreeColumns = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill="currentcolor" fill-rule="evenodd" d="M0 2.375C0 1.615.616 1 1.375 1h1.5c.76 0 1.375.616 1.375 1.375v11.25c0 .76-.616 1.375-1.375 1.375h-1.5C.615 15 0 14.384 0 13.625zm1.5.125v11h1.25v-11zm4.25-.125C5.75 1.615 6.366 1 7.125 1h1.75c.76 0 1.375.616 1.375 1.375v11.25c0 .76-.616 1.375-1.375 1.375h-1.75c-.76 0-1.375-.616-1.375-1.375zm1.5.125v11h1.5v-11zm4.5-.125c0-.76.616-1.375 1.375-1.375h1.5C15.385 1 16 1.616 16 2.375v11.25c0 .76-.616 1.375-1.375 1.375h-1.5c-.76 0-1.375-.616-1.375-1.375zm1.5.125v11h1.25v-11z" clip-rule="evenodd"></path></svg>
)

export const IconThreeColumnsMiddle = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill="currentcolor" fill-rule="evenodd" d="M0 2.375C0 1.615.616 1 1.375 1h.75c.76 0 1.375.616 1.375 1.375v11.25c0 .76-.616 1.375-1.375 1.375h-.75C.615 15 0 14.384 0 13.625zm1.5.125v11H2v-11zM5 2.375C5 1.615 5.616 1 6.375 1h3.25C10.385 1 11 1.616 11 2.375v11.25c0 .76-.616 1.375-1.375 1.375h-3.25C5.615 15 5 14.384 5 13.625zm1.5.125v11h3v-11zm6-.125c0-.76.616-1.375 1.375-1.375h.75C15.385 1 16 1.616 16 2.375v11.25c0 .76-.616 1.375-1.375 1.375h-.75c-.76 0-1.375-.616-1.375-1.375zM14 2.5v11h.5v-11z" clip-rule="evenodd"></path>
  </svg>
)

export const IconThreeColumnsLeft = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill-rule="evenodd" d="M7.5 1.375C7.5 0.615609 8.11561 0 8.875 0H9.625C10.3844 0 11 0.615608 11 1.375V12.625C11 13.3844 10.3844 14 9.625 14H8.875C8.11561 14 7.5 13.3844 7.5 12.625V1.375ZM9 1.5V12.5H9.5V1.5H9ZM0 1.37505C0 0.615655 0.615608 4.66853e-05 1.375 4.66853e-05H4.625C5.38439 4.66853e-05 6 0.615655 6 1.37505V12.625C6 13.3844 5.38439 14 4.625 14H1.375C0.615608 14 0 13.3844 0 12.625V1.37505ZM1.5 1.50005V12.5H4.5V1.50005H1.5ZM12.5 1.37505C12.5 0.615655 13.1156 4.66853e-05 13.875 4.66853e-05H14.625C15.3844 4.66853e-05 16 0.615655 16 1.37505V12.625C16 13.3844 15.3844 14 14.625 14H13.875C13.1156 14 12.5 13.3844 12.5 12.625V1.37505ZM14 1.50005V12.5H14.5V1.50005H14Z" fill="currentcolor"></path>
  </svg>
)

export const IconThreeColumnsRight = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" xmlns="http://www.w3.org/2000/svg" role="presentation"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 1.375C8.5 0.615609 7.88439 0 7.125 0H6.375C5.61561 0 5 0.615608 5 1.375V12.625C5 13.3844 5.61561 14 6.375 14H7.125C7.88439 14 8.5 13.3844 8.5 12.625V1.375ZM7 1.5V12.5H6.5V1.5H7ZM16 1.37505C16 0.615655 15.3844 4.66853e-05 14.625 4.66853e-05H11.375C10.6156 4.66853e-05 10 0.615655 10 1.37505V12.625C10 13.3844 10.6156 14 11.375 14H14.625C15.3844 14 16 13.3844 16 12.625V1.37505ZM14.5 1.50005V12.5H11.5V1.50005H14.5ZM3.5 1.37505C3.5 0.615655 2.88439 4.66853e-05 2.125 4.66853e-05H1.375C0.615608 4.66853e-05 0 0.615655 0 1.37505V12.625C0 13.3844 0.615608 14 1.375 14H2.125C2.88439 14 3.5 13.3844 3.5 12.625V1.37505ZM2 1.50005V12.5H1.5V1.50005H2Z" fill="currentcolor"></path>
  </svg>
)

export const IconTwoColumns = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill="currentcolor" fill-rule="evenodd" d="M0 2.375C0 1.615.616 1 1.375 1h4.5c.76 0 1.375.616 1.375 1.375v11.25c0 .76-.616 1.375-1.375 1.375h-4.5C.615 15 0 14.384 0 13.625zm1.5.125v11h4.25v-11zm7.25-.125c0-.76.616-1.375 1.375-1.375h4.5C15.385 1 16 1.616 16 2.375v11.25c0 .76-.616 1.375-1.375 1.375h-4.5c-.76 0-1.375-.616-1.375-1.375zm1.5.125v11h4.25v-11z" clip-rule="evenodd"></path>
  </svg>
)

export const IconTwoColumnsLeft = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill="currentcolor" fill-rule="evenodd" d="M0 2.375C0 1.615.616 1 1.375 1h7.75c.76 0 1.375.616 1.375 1.375v11.25c0 .76-.616 1.375-1.375 1.375h-7.75C.615 15 0 14.384 0 13.625zm1.5.125v11H9v-11zM12 2.375C12 1.615 12.616 1 13.375 1h1.25C15.385 1 16 1.616 16 2.375v11.25c0 .76-.616 1.375-1.375 1.375h-1.25c-.76 0-1.375-.616-1.375-1.375zm1.5.125v11h1v-11z" clip-rule="evenodd"></path>
  </svg>
)

export const IconTwoColumnsRight = buildIcon(
  <svg width="1em" height="1em" fill="currentColor" viewBox="-3 -3 20 20" role="presentation"><path fill="currentcolor" fill-rule="evenodd" d="M16 2.375C16 1.615 15.384 1 14.625 1h-7.75C6.115 1 5.5 1.616 5.5 2.375v11.25c0 .76.616 1.375 1.375 1.375h7.75c.76 0 1.375-.616 1.375-1.375zm-1.5.125v11H7v-11zM4 2.375C4 1.615 3.384 1 2.625 1h-1.25C.615 1 0 1.616 0 2.375v11.25C0 14.385.616 15 1.375 15h1.25C3.385 15 4 14.384 4 13.625zM2.5 2.5v11h-1v-11z" clip-rule="evenodd"></path></svg>
)