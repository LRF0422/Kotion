...
- [apps/landing-page/tailwind.config.js](file://apps/landing-page/tailwind.config.js)
- [apps/landing-page/postcss.config.cjs](file://apps/landing-page/postcss.config.cjs)
- [apps/landing-page-vite/vite.config.ts](file://apps/landing-page-vite/vite.config.ts)
- [apps/landing-page-vite/tailwind.config.js](file://apps/landing-page-vite/tailwind.config.js)
- [apps/landing-page-vite/postcss.config.cjs](file://apps/landing-page-vite/postcss.config.cjs)
- [apps/vite/vite.config.ts](file://apps/vite/vite.config.ts)
- [packages/editor/tailwind.config.js](file://packages/editor/tailwind.config.js)
- [packages/editor/postcss.config.cjs](file://packages/editor/postcss.config.cjs)
...
- [packages/common/rollup.config.mjs](file://packages/common/rollup.config.mjs)
...
章节来源
- [packages/rollup-config/index.js](file://packages/rollup-config/index.js#L1-L143)
- [packages/common/rollup.config.mjs](file://packages/common/rollup.config.mjs#L1-L5)
...
```mermaid
flowchart TD
Cfg["Tailwind 配置"] --> ContentScan["扫描内容目录"]
ContentScan --> BuildCSS["生成所需 CSS"]
BuildCSS --> PostCSS["PostCSS 插件处理"]
PostCSS --> Output["输出优化后的 CSS"]
```
...
- [packages/ui/tailwind.config.js](file://packages/ui/tailwind.config.js#L1-L145)
- [packages/ui/postcss.config.js](file://packages/ui/postcss.config.js#L1-L8)
- [apps/landing-page/tailwind.config.js](file://apps/landing-page/tailwind.config.js#L1-L2)
- [apps/landing-page/postcss.config.cjs](file://apps/landing-page/postcss.config.cjs#L1-L2)
- [apps/landing-page-vite/tailwind.config.js](file://apps/landing-page-vite/tailwind.config.js#L1-L2)
- [apps/landing-page-vite/postcss.config.cjs](file://apps/landing-page-vite/postcss.config.cjs#L1-L2)
- [packages/editor/tailwind.config.js](file://packages/editor/tailwind.config.js#L1-L2)
- [packages/editor/postcss.config.cjs](file://packages/editor/postcss.config.cjs#L1-L2)
...
## 结论
通过统一的构建与打包策略、Tailwind/PostCSS 的按需构建、Nginx 的缓存与反向代理、以及完善的监控与优化实践，知识库管理系统可在多端获得稳定且高效的性能表现。建议持续关注包体变化、关键指标与用户体验，结合业务增长迭代优化策略。

## 附录
- 关键配置参考路径
  - Next.js 构建输出：[apps/landing-page/next.config.mjs](file://apps/landing-page/next.config.mjs#L1-L9)
  - Vite 开发服务器与代理：[apps/landing-page-vite/vite.config.ts](file://apps/landing-page-vite/vite.config.ts#L1-L22)、[apps/vite/vite.config.ts](file://apps/vite/vite.config.ts#L1-L21)
