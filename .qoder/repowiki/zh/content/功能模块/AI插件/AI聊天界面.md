...
- [packages/core/src/ai/system-agent/hooks.tsx](file://packages/core/src/ai/system-agent/hooks.tsx)
...
- 增强工具执行步骤显示和错误处理机制
- 优化流式消息渲染和性能表现
- **更新** 错误处理机制增强：错误消息现在直接显示在聊天界面中，而不是留空气泡，改进了用户反馈机制
- **更新** 增强的错误分类系统：支持网络、认证、速率限制、超时、服务器等多种错误类型
- **更新** 改进的用户反馈机制：通过消息气泡和专门的错误显示组件提供更好的用户体验
...
- **新增** 消息历史管理与持久化功能
- **新增** 工具执行步骤显示和错误处理机制
- **更新** 增强的错误处理：错误消息现在直接显示在聊天界面中，提供更好的用户反馈
...
- **新增** 系统代理钩子：packages/core/src/ai/system-agent/hooks.tsx
...
- **新增** 错误显示组件：packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx
...
ERROR_DISPLAY["ErrorDisplay.tsx<br/>错误显示组件"]
end
...
SYSTEM_HOOKS["system-agent/hooks.tsx<br/>系统代理钩子"]
...
**图表来源**
- [packages/plugin-ai/src/ai/index.tsx:1-42](file://packages/plugin-ai/src/ai/index.tsx#L1-L42)
...
- [packages/plugin-ai/src/ai/utils.ts:1-58](file://packages/plugin-ai/src/ai/utils.ts#L1-L58)
- [packages/plugin-ai/src/ai/menu/AiStaticMenu.tsx:1-48](file://packages/plugin-ai/src/ai/menu/AiStaticMenu.tsx#L1-L48)
- [packages/plugin-ai/src/ai/menu/Chat.tsx:47-154](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L47-L154)
...
- [packages/plugin-ai/src/ai/menu/MessageBubble.tsx:1-99](file://packages/plugin-ai/src/ai/menu/MessageBubble.tsx#L1-L99)
...
- [packages/core/src/ai/use-agent-optimized.tsx:1-344](file://packages/core/src/ai/use-agent-optimized.tsx#L1-L344)
...
- [packages/ui/src/components/ui/expandable-chat.tsx:1-417](file://packages/ui/src/components/ui/expandable-chat.tsx#L1-L417)
- [packages/core/src/pages/AIAssistantPage.tsx:1-470](file://packages/core/src/pages/AIAssistantPage.tsx#L1-L470)
- [packages/core/src/ai/system-agent/context.tsx:1-352](file://packages/core/src/ai/system-agent/context.tsx#L1-L352)
- [packages/core/src/ai/system-agent/hooks.tsx:1-256](file://packages/core/src/ai/system-agent/hooks.tsx#L1-L256)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:1-520](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L1-L520)
- [packages/core/src/ai/constants.ts:1-228](file://packages/core/src/ai/constants.ts#L1-L228)
...
- 浮动聊天面板
  ...
  - **更新** 错误处理：错误消息现在作为AI消息直接显示在聊天界面中
- **新增** 独立AI助手页面
...
- **新增** 错误显示组件
  - ErrorDisplay：专门的错误显示组件，支持重试和关闭操作
  - 支持多种错误类型：网络、认证、速率限制、超时、服务器、未知
- 编辑器Agent封装
...
- [packages/plugin-ai/src/ai/menu/Chat.tsx:47-154](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L47-L154)
- [packages/core/src/ai/use-agent-optimized.tsx:1-344](file://packages/core/src/ai/use-agent-optimized.tsx#L1-L344)
- [packages/core/src/ai/AiInlineMenu.tsx:75-243](file://packages/core/src/ai/AiInlineMenu.tsx#L75-L243)
- [packages/core/src/pages/AIAssistantPage.tsx:1-470](file://packages/core/src/pages/AIAssistantPage.tsx#L1-L470)
- [packages/core/src/ai/system-agent/context.tsx:1-352](file://packages/core/src/ai/system-agent/context.tsx#L1-L352)
- [packages/core/src/ai/system-agent/hooks.tsx:1-256](file://packages/core/src/ai/system-agent/hooks.tsx#L1-L256)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:1-520](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L1-L520)
...
## 架构总览
AI聊天界面由"编辑器内节点 + 全局聊天面板 + 加载态装饰 + Agent能力 + 独立AI助手页面 + 系统代理提供者 + 错误处理系统"八部分组成，通过插件装配统一接入编辑器。
...
ChatPanel --> ErrorHandling["错误处理系统<br/>错误消息直接显示"]
...
SystemContext --> SystemHooks["SystemAgentHooks<br/>system-agent/hooks.tsx"]
...
ErrorHandling --> ErrorDisplay["ErrorDisplay组件<br/>支持重试和关闭"]
ErrorHandling --> MessageBubble["MessageBubble<br/>错误样式显示"]
ErrorHandling --> ChatTypes["chat-types<br/>错误类型定义"]
```
...
**图表来源**
- [packages/plugin-ai/src/ai/menu/AiStaticMenu.tsx:1-48](file://packages/plugin-ai/src/ai/menu/AiStaticMenu.tsx#L1-L48)
- [packages/plugin-ai/src/ai/utils.ts:1-31](file://packages/plugin-ai/src/ai/utils.ts#L1-L31)
- [packages/plugin-ai/src/ai/text-loading.tsx:1-146](file://packages/plugin-ai/src/ai/text-loading.tsx#L1-L146)
...
- 交互流程
  ...
  - **更新** 错误处理：当发生错误时，错误消息被包装在AI消息中显示，而不是留空气泡
...
**图表来源**
- [packages/plugin-ai/src/ai/menu/Chat.tsx:153-221](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L153-L221)
- [packages/ui/src/components/ui/expandable-chat.tsx:1-417](file://packages/ui/src/components/ui/expandable-chat.tsx#L1-L417)
- [packages/core/src/ai/use-agent-optimized.tsx:286-317](file://packages/core/src/ai/use-agent-optimized.tsx#L286-L317)
...
- 功能要点
  ...
  - SystemAgentProvider：全局AI代理提供者，管理代理状态和生命周期
  - 消息历史管理：支持消息持久化和历史记录
  - **更新** 错误处理：通过SystemAgentProvider的状态管理显示错误信息
- 交互流程
  - 用户输入 -> 创建用户消息 -> 创建AI消息 -> 流式生成 -> 更新消息内容 -> 显示工具执行步骤
  - **更新** 错误处理：当SystemAgentProvider检测到错误时，在页面顶部显示错误横幅
...
**图表来源**
- [packages/core/src/pages/AIAssistantPage.tsx:46-121](file://packages/core/src/pages/AIAssistantPage.tsx#L46-L121)
- [packages/core/src/ai/system-agent/context.tsx:159-235](file://packages/core/src/ai/system-agent/context.tsx#L159-L235)
...
**图表来源**
- [packages/core/src/ai/system-agent/context.tsx:28-73](file://packages/core/src/ai/system-agent/context.tsx#L28-L73)
...
- 交互流程
  ...
  - **更新** 错误处理：当SystemAgentProvider检测到错误时，在面板底部显示错误横幅
...
**图表来源**
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:74-167](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L74-L167)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:499-519](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L499-L519)

**章节来源**
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:1-520](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L1-L520)
- [packages/core/src/ai/system-agent/hooks.tsx:138-159](file://packages/core/src/ai/system-agent/hooks.tsx#L138-L159)
...
**图表来源**
- [packages/plugin-ai/src/ai/menu/chat-persistence.ts:13-40](file://packages/plugin-ai/src/ai/menu/chat-persistence.ts#L13-L40)
...
**图表来源**
- [packages/plugin-ai/src/ai/AiImageView.tsx:1-69](file://packages/plugin-ai/src/ai/AiImageView.tsx#L1-L69)
- [packages/plugin-ai/src/ai/utils.ts:43-58](file://packages/plugin-ai/src/ai/utils.ts#L43-L58)
...
- 功能要点
  ...
  - **错误消息**：采用红色渐变背景（bg-red-50 dark:bg-red-950/30），边框样式（border border-red-200/60 dark:border-red-900/40），文本颜色（text-red-700 dark:text-red-300）
...
- **更新** 错误消息样式
  - 错误消息具有特殊的红色样式，包含错误图标和错误标题
  - 支持深色模式下的红色样式适配
  - 错误消息包含"Error"标题和错误图标
- 技术实现
...
ErrorMsg["错误消息气泡"] --> RedGradient["红色渐变背景<br/>bg-red-50 dark:bg-red-950/30"]
RedGradient --> RedBorder["红色边框<br/>border border-red-200/60 dark:border-red-900/40"]
RedBorder --> RedText["红色文本<br/>text-red-700 dark:text-red-300"]
RedText --> ErrorIcon["错误图标<br/>AlertCircle"]
ErrorIcon --> ErrorTitle["错误标题<br/>Error"]
```

**图表来源**
- [packages/plugin-ai/src/ai/menu/Chat.tsx:395-415](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L395-L415)
- [packages/plugin-ai/src/ai/menu/MessageBubble.tsx:55-58](file://packages/plugin-ai/src/ai/menu/MessageBubble.tsx#L55-L58)
...
**图表来源**
- [packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts:17-22](file://packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts#L17-L22)

**章节来源**
- [packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts:1-46](file://packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts#L1-L46)

### 组件M：错误处理系统（Error Handling System）
- 功能要点
  - **错误分类**：支持网络、认证、速率限制、超时、服务器、未知六种错误类型
  - **错误显示**：错误消息现在直接显示在聊天界面中，而不是留空气泡
  - **错误重试**：支持错误重试功能，提供友好的用户交互
  - **错误状态管理**：通过SystemAgentProvider统一管理错误状态
- 错误类型定义
  - network：网络连接失败
  - auth：认证失败
  - rate_limit：请求过于频繁
  ...
  - unknown：未知错误
- 错误处理流程
  - 错误发生 -> 分类错误 -> 创建AI消息显示错误 -> 提供重试选项 -> 用户重试

```mermaid
flowchart TD
ErrorOccur["错误发生"] --> Classify["分类错误"]
Classify --> Network{"网络错误？"}
Network --> |是| NetworkError["network错误"]
Network --> |否| Auth{"认证错误？"}
Auth --> |是| AuthError["auth错误"]
Auth --> |否| RateLimit{"速率限制？"}
RateLimit --> |是| RateError["rate_limit错误"]
RateLimit --> |否| Timeout{"超时？"}
Timeout --> |是| TimeError["timeout错误"]
Timeout --> |否| Server{"服务器错误？"}
Server --> |是| ServerError["server错误"]
Server --> |否| Unknown["unknown错误"]
Unknown --> CreateMessage["创建AI消息显示错误"]
NetworkError --> CreateMessage
AuthError --> CreateMessage
RateError --> CreateMessage
TimeError --> CreateMessage
ServerError --> CreateMessage
CreateMessage --> ShowError["显示错误消息气泡"]
ShowError --> Retry{"用户重试？"}
Retry --> |是| RetryAction["重试操作"]
Retry --> |否| Dismiss["关闭错误"]
RetryAction --> Success["重试成功"]
Success --> ClearError["清除错误状态"]
```

**图表来源**
- [packages/plugin-ai/src/ai/menu/chat-types.ts:48-77](file://packages/plugin-ai/src/ai/menu/chat-types.ts#L48-L77)
- [packages/plugin-ai/src/ai/menu/Chat.tsx:352-370](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L352-L370)
- [packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx:21-56](file://packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx#L21-L56)

**章节来源**
- [packages/plugin-ai/src/ai/menu/chat-types.ts:31-77](file://packages/plugin-ai/src/ai/menu/chat-types.ts#L31-L77)
- [packages/plugin-ai/src/ai/menu/Chat.tsx:352-370](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L352-L370)
- [packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx:1-57](file://packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx#L1-L57)

### 组件N：错误显示组件（ErrorDisplay）
- 功能要点
  - 专门的错误显示组件，支持重试和关闭操作
  - 不同类型的错误使用不同的图标和样式
  - 支持可重试和不可重试的错误类型
- 错误图标映射
  - network：WifiOff（网络图标）
  - auth：ShieldAlert（认证图标）
  - rate_limit：Timer（计时器图标）
  - timeout：Timer（计时器图标）
  - server：AlertTriangle（警告三角形）
  - unknown：XCircle（错误圆圈）
- 用户交互
  - 重试按钮：仅对可重试的错误显示
  - 关闭按钮：关闭错误显示
  - 错误消息：显示详细的错误信息
...
```mermaid
flowchart TD
ErrorDisplay["ErrorDisplay组件"] --> IconSelect["根据错误类型选择图标"]
IconSelect --> NetworkIcon["WifiOff"]
IconSelect --> AuthIcon["ShieldAlert"]
IconSelect --> RateIcon["Timer"]
IconSelect --> TimeoutIcon["Timer"]
IconSelect --> ServerIcon["AlertTriangle"]
IconSelect --> UnknownIcon["XCircle"]
ErrorDisplay --> Message["显示错误消息"]
ErrorDisplay --> RetryBtn["重试按钮可选"]
ErrorDisplay --> DismissBtn["关闭按钮"]
RetryBtn --> RetryAction["执行重试操作"]
DismissBtn --> DismissAction["关闭错误显示"]
```

**图表来源**
- [packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx:6-13](file://packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx#L6-L13)
- [packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx:21-56](file://packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx#L21-L56)
...
- 组件耦合
  ...
  - **新增** 错误处理系统依赖 ErrorDisplay 组件和 chat-types
  - 静态菜单依赖aiText工具函数
  - MessageBubble 依赖 ChatBubble 组件和流式渲染
  - **更新** 错误处理增强：Chat.tsx 和 AIAssistantPage 都集成了错误处理机制
- 外部依赖
...
Chat --> MessageBubble
Chat --> ErrorDisplay["ErrorDisplay.tsx"]
...
- [packages/plugin-ai/src/ai/index.tsx:1-42](file://packages/plugin-ai/src/ai/index.tsx#L1-L42)
- [packages/plugin-ai/src/ai/marks/loading-mark.tsx:1-36](file://packages/plugin-ai/src/ai/marks/loading-mark.tsx#L1-L36)
- [packages/plugin-ai/src/ai/menu/Chat.tsx:114-221](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L114-L221)
- [packages/core/src/ai/AiInlineMenu.tsx:137-145](file://packages/core/src/ai/AiInlineMenu.tsx#L137-L145)
- [packages/core/src/ai/types.ts:61-88](file://packages/core/src/ai/types.ts#L61-L88)
- [packages/plugin-ai/src/ai/menu/MessageBubble.tsx:1-99](file://packages/plugin-ai/src/ai/menu/MessageBubble.tsx#L1-L99)
- [packages/ui/src/components/ui/expandable-chat.tsx:1-417](file://packages/ui/src/components/ui/expandable-chat.tsx#L1-L417)
- [packages/core/src/ai/use-agent-optimized.tsx:1-344](file://packages/core/src/ai/use-agent-optimized.tsx#L1-L344)
- [packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts:1-46](file://packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts#L1-L46)
- [packages/core/src/pages/AIAssistantPage.tsx:32-470](file://packages/core/src/pages/AIAssistantPage.tsx#L32-L470)
- [packages/core/src/ai/system-agent/context.tsx:1-352](file://packages/core/src/ai/system-agent/context.tsx#L1-L352)
- [packages/core/src/ai/system-agent/hooks.tsx:1-256](file://packages/core/src/ai/system-agent/hooks.tsx#L1-L256)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:1-520](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L1-L520)
- [packages/plugin-ai/src/ai/menu/chat-persistence.ts:1-68](file://packages/plugin-ai/src/ai/menu/chat-persistence.ts#L1-L68)
...
- 性能
  ...
  - **新增** 错误处理优化：错误消息直接显示在聊天界面中，避免额外的UI层叠
...
- 交互优化
  ...
  - **新增** 错误重试：支持错误重试功能，提供更好的用户容错体验
  - **新增** 错误分类：提供详细的错误分类和图标，帮助用户理解错误原因
  - 消息气泡：渐变背景提供更好的视觉层次，区分用户和AI消息
  - **更新** 错误消息：错误消息具有特殊的红色样式，提供清晰的错误提示
- 用户体验
  ...
  - **新增** 工具执行步骤：实时显示AI执行的工具调用过程，增加透明度
  - **新增** 用户选择对话：支持AI发起的选择对话，提供更好的交互体验
  - **新增** 错误处理增强：错误消息直接显示在聊天界面中，提供更好的用户反馈
  - **新增** 错误重试：支持一键重试，提升用户操作便利性
  - **新增** 错误分类：提供详细的错误类型和图标，帮助用户快速理解问题
  - 视觉一致性：渐变色彩方案在整个聊天界面中保持统一
  - **更新** 错误样式：红色渐变背景和边框提供清晰的错误视觉提示
...
- **新增** 消息历史问题
  ...
  - 验证token估算算法是否正确
- **新增** 错误处理问题
  - 检查ErrorDisplay组件是否正确渲染
  - 确认错误分类函数classifyError是否正确工作
  - 验证错误消息是否正确显示在聊天界面中
  - **新增** 检查错误重试功能是否正常
- 渐变样式不生效
...
- [packages/ui/src/components/ui/expandable-chat.tsx:1-417](file://packages/ui/src/components/ui/expandable-chat.tsx#L1-L417)
- [packages/core/src/ai/use-agent-optimized.tsx:1-344](file://packages/core/src/ai/use-agent-optimized.tsx#L1-L344)
- [packages/core/src/ai/AiInlineMenu.tsx:210-243](file://packages/core/src/ai/AiInlineMenu.tsx#L210-L243)
- [packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts:36-42](file://packages/plugin-ai/src/ai/menu/use-streaming-buffer.ts#L36-L42)
- [packages/ui/tailwind.config.js:1-52](file://packages/ui/tailwind.config.js#L1-L52)
- [packages/core/src/pages/AIAssistantPage.tsx:1-470](file://packages/core/src/pages/AIAssistantPage.tsx#L1-L470)
- [packages/core/src/ai/system-agent/context.tsx:1-352](file://packages/core/src/ai/system-agent/context.tsx#L1-L352)
- [packages/plugin-ai/src/ai/menu/chat-persistence.ts:1-68](file://packages/plugin-ai/src/ai/menu/chat-persistence.ts#L1-L68)
- [packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx:1-57](file://packages/plugin-ai/src/ai/menu/ErrorDisplay.tsx#L1-L57)
...
## 结论
AI聊天界面通过"编辑器内节点 + 全局聊天面板 + 加载态装饰 + Agent能力 + 独立AI助手页面 + 系统代理提供者 + 错误处理系统"形成完整的闭环：既能对文档内容进行智能增强，也能提供全局对话式交互。其模块化设计便于扩展与定制，结合流式渲染与本地化支持，能够满足多样化的编辑场景需求。
...
**最重要的更新**是错误处理机制的增强：错误消息现在直接显示在聊天界面中，而不是留空气泡，这大大改进了用户反馈机制。通过专门的ErrorDisplay组件和增强的消息气泡样式，用户可以更清楚地看到错误信息并进行相应的操作（如重试）。这种改进使得AI聊天界面更加健壮和用户友好，提供了更好的错误处理体验。
...
- 在插件中注册AIExtension，即可获得：
  ...
  - **新增** 错误处理：错误消息直接显示在聊天界面中，提供更好的用户反馈
...
- **新增** 独立AI助手页面
  ...
  - **新增** 错误处理：当SystemAgentProvider检测到错误时，在页面顶部显示错误横幅
- **新增** AI助手面板
  - 用户输入 -> AIAssistantPanel创建消息 -> SystemAgentProvider流式生成 -> 实时更新消息内容 -> 显示工具执行步骤
  - **新增** 错误处理：当SystemAgentProvider检测到错误时，在面板底部显示错误横幅
- 编辑器内生成
  - AiView/AiStaticMenu -> utils.aiText -> 流式插入 -> 装饰更新 -> 最终插入完整结果

**章节来源**
- [packages/plugin-ai/src/ai/menu/Chat.tsx:153-221](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L153-L221)
- [packages/core/src/pages/AIAssistantPage.tsx:82-121](file://packages/core/src/pages/AIAssistantPage.tsx#L82-L121)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:127-167](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L127-L167)
- [packages/plugin-ai/src/ai/utils.ts:1-31](file://packages/plugin-ai/src/ai/utils.ts#L1-L31)
- [packages/plugin-ai/src/ai/AiView.tsx:1-76](file://packages/plugin-ai/src/ai/AiView.tsx#L1-L76)
...
- **渐变背景定制**：
  ...
  - 错误消息：使用红色渐变背景（bg-red-50 dark:bg-red-950/30）和边框样式
...
- **新增** 错误消息样式定制：
  - 红色渐变背景：bg-red-50 dark:bg-red-950/30
  - 红色边框：border border-red-200/60 dark:border-red-900/40
  - 红色文本：text-red-700 dark:text-red-300
  - 错误图标：AlertCircle
  - 错误标题：Error
- 装饰样式：可通过CSS类名覆盖loading-decoration容器样式
- 本地化：插件提供中英文翻译键值，可在运行时切换语言
- **深色模式适配**：所有渐变背景都提供了dark:前缀的深色版本
- **更新** 错误样式适配：错误消息完全适配深色模式，确保在暗色背景下仍有良好的可读性

**章节来源**
- [packages/ui/src/components/ui/expandable-chat.tsx:1-417](file://packages/ui/src/components/ui/expandable-chat.tsx#L1-L417)
- [packages/plugin-ai/src/index.tsx:1-35](file://packages/plugin-ai/src/index.tsx#L1-L35)
- [packages/plugin-ai/src/ai/menu/Chat.tsx:395-415](file://packages/plugin-ai/src/ai/menu/Chat.tsx#L395-L415)
- [packages/core/src/pages/AIAssistantPage.tsx:164-431](file://packages/core/src/pages/AIAssistantPage.tsx#L164-L431)
- [packages/core/src/ai/system-agent/AIAssistantPanel.tsx:210-454](file://packages/core/src/ai/system-agent/AIAssistantPanel.tsx#L210-L454)
- [packages/ui/package.json:84-85](file://packages/ui/package.json#L84-L85)
- [packages/ui/tailwind.config.js:1-52](file://packages/ui/tailwind.config.js#L1-L52)
- [packages/plugin-ai/src/ai/menu/MessageBubble.tsx:42-53](file://packages/plugin-ai/src/ai/menu/MessageBubble.tsx#L42-L53)