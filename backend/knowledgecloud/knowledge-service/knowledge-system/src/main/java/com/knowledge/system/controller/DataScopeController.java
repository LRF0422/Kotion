...
import com.knowledge.core.tool.utils.CacheUtil;
import com.knowledge.core.tool.utils.Func;
import com.knowledge.system.domain.DataScope;
import com.knowledge.system.service.IDataScopeService;
import com.knowledge.system.vo.DataScopeVO;
import com.knowledge.system.wrapper.DataScopeWrapper;
import org.springframework.web.bind.annotation.*;

import javax.validation.Valid;

import static com.knowledge.core.tool.utils.CacheUtil.SYS_CACHE;
...
public class DataScopeController extends KnowledgeController {
	...
	public R remove(@ApiParam(value = "主键集合", required = true) @RequestParam String ids) {
		CacheUtil.clear(SYS_CACHE);
		return R.status(dataScopeService.removeBatchByIds(Func.toLongList(ids)));
	}
