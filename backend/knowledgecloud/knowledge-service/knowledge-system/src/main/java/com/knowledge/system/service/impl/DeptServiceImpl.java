...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
	...
	public boolean submit(Dept dept) {
		...
		if (Func.isEmpty(dept.getParentId())) {
			dept.setTenantId(SecurityContextUtil.getTenantId());
			dept.setParentId(KnowledgeConstant.TOP_PARENT_ID);
			dept.setAncestors(String.valueOf(KnowledgeConstant.TOP_PARENT_ID));
		}
		...
		dept.setIsDeleted(KnowledgeConstant.DB_NOT_DELETED);
