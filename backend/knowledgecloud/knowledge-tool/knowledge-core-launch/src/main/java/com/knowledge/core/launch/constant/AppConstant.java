...
public interface AppConstant {
	 ...
	 * 基础包
	 */
	String BASE_PACKAGES = "com.knowledge";

	/**
	 * 应用名前缀
	 */
	String APPLICATION_NAME_PREFIX = "knowledge-";
	/**
	 * 网关模块名称
	 */
	 ...
	 * wiki模块
	 */
	String APPLICATION_WIKI_NAME = APPLICATION_NAME_PREFIX + "wiki";

	String APPLICATION_WIDGET_HUB_NAME = APPLICATION_NAME_PREFIX + "widget-hub";

	String APPLICATION_FILE_CENTER_NAME = APPLICATION_NAME_PREFIX + "file-center";

	String APPLICATION_MESSAGE_NAME = APPLICATION_NAME_PREFIX + "message";
	/**
	 * Agent Skills模块
	 */
	String APPLICATION_AGENT_SKILLS_NAME = APPLICATION_NAME_PREFIX + "agent";
	/**
	 * 数据中心模块
	 */
	String APPLICATION_DATA_CENTER_NAME = APPLICATION_NAME_PREFIX + "data-center";
	/**
	 * 测试模块名称
	 */
