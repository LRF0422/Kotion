 ...
 */
@AllArgsConstructor
public class AliossTemplate implements OssClient {
	...
	@SneakyThrows
	public KnowledgeFile putFile(String fileName, InputStream stream) {
	...
	@SneakyThrows
	public KnowledgeFile put(String bucketName, InputStream stream, String key, boolean cover) {
