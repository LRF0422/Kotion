...
public class KnowledgeFileUtil {
	 ...
	 */
	public static KnowledgeFile getFile(MultipartFile file) {
	 ...
	 * @return knowledgeFile
	 */
	public static KnowledgeFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return knowledgeFile
	 */
	public static KnowledgeFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new KnowledgeFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return knowledgeFile
	 */
	public static List<KnowledgeFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return knowledgeFile
	 */
	public static List<KnowledgeFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return knowledgeFile
	 */
	public static List<KnowledgeFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<KnowledgeFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new KnowledgeFile(file, dir, path, virtualPath));
		}
		return list;
	}
