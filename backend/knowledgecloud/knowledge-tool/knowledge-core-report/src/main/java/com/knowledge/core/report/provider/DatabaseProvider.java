 ...
 */
package com.knowledge.core.report.provider;

import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.bstek.ureport.provider.report.ReportFile;
import com.bstek.ureport.provider.report.ReportProvider;
import lombok.AllArgsConstructor;
import com.knowledge.core.report.entity.ReportFileEntity;
...
public class DatabaseProvider implements ReportProvider {
	...
	public void saveReport(String file, String content) {
		...
		if (reportFileEntity == null) {
			...
			reportFileEntity.setIsDeleted(KnowledgeConstant.DB_NOT_DELETED);
		} else {
			reportFileEntity.setContent(content.getBytes());
		}
