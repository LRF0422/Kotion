 ...
 */
package com.knowledge.core.cloud.http;


import com.fasterxml.jackson.databind.ObjectMapper;
import lombok.AllArgsConstructor;
import com.knowledge.core.cloud.header.KnowledgeFeignAccountGetter;
import com.knowledge.core.cloud.props.KnowledgeFeignHeadersProperties;
import com.knowledge.core.tool.utils.Charsets;
...
@EnableConfigurationProperties(KnowledgeFeignHeadersProperties.class)
public class RestTemplateConfiguration {
	...
	public RestTemplateHeaderInterceptor requestHeaderInterceptor(
		@Autowired(required = false) @Nullable KnowledgeFeignAccountGetter accountGetter,
		KnowledgeFeignHeadersProperties properties) {
	...
	public RestTemplate restTemplate(okhttp3.OkHttpClient httpClient, RestTemplateHeaderInterceptor interceptor) {
