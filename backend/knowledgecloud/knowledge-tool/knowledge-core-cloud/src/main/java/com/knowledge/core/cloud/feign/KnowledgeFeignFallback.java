...
/**
 * knowledge fallBack 代理处理
 *
 * @author L.cm
 */
@Slf4j
@AllArgsConstructor
public class KnowledgeFeignFallback<T> implements MethodInterceptor {
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
		...
		log.error("knowledgeFeignFallback:[{}.{}] serviceId:[{}] message:[{}]", targetType.getName(), method.getName(), targetName, errorMessage);
	...
	public boolean equals(Object o) {
		...
		KnowledgeFeignFallback<?> that = (KnowledgeFeignFallback<?>) o;
