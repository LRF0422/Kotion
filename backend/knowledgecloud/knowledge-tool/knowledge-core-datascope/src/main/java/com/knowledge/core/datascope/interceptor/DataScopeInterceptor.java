 ...
 */
package com.knowledge.core.datascope.interceptor;
...
import com.knowledge.core.datascope.annotation.DataAuth;
...
import com.knowledge.core.tool.utils.ClassUtil;
import com.knowledge.core.tool.utils.SpringUtil;
...
public class DataScopeInterceptor implements QueryInterceptor {
	...
	public void intercept(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds,
		...
		// 未取到用户则放行
		KnowledgeUser knowledgeUser = SecureUtil.getUser();
		...
		// 获取数据权限规则对应的筛选Sql
		String sqlCondition = dataScopeHandler.sqlCondition(mapperId, dataScope, knowledgeUser, originalSql);
