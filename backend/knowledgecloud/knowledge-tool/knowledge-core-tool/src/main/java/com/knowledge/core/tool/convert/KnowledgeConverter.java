...
import com.knowledge.core.tool.support.Try;
import com.knowledge.core.tool.utils.ClassUtil;
import com.knowledge.core.tool.utils.ConvertUtil;
import com.knowledge.core.tool.utils.ReflectUtil;
...
@Slf4j
@AllArgsConstructor
public class KnowledgeConverter implements Converter {
	 ...
	 * @param fieldName 目标的field名，原为 set 方法名，knowledgeBeanCopier 里做了更改
	 * @return {Object}
	 */
	@Override
	@Nullable
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = KnowledgeConverter.getTypeDescriptor(targetClazz, (String) fieldName);
			return ConvertUtil.convert(value, targetDescriptor);
		} catch (Throwable e) {
			log.warn("knowledgeConverter error", e);
			return null;
		}
	}
