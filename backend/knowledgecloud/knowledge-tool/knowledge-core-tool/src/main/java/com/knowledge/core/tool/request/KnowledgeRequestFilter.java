 ...
 */
@AllArgsConstructor
public class KnowledgeRequestFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		// 默认 Request 包装
			...
			KnowledgeHttpServletRequestWrapper knowledgeRequest = new KnowledgeHttpServletRequestWrapper((HttpServletRequest) request);
			chain.doFilter(knowledgeRequest, response);
		}
		// Xss Request 包装
		else {
