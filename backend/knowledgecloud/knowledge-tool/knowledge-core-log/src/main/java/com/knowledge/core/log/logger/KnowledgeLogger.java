 ...
 */
package com.knowledge.core.log.logger;

import lombok.extern.slf4j.Slf4j;
import com.knowledge.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class KnowledgeLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": knowledgeLogger init success!");
	}
