 ...
 */
package com.knowledge.core.log.error;
 ...
 * @author Chill
 */
public class KnowledgeErrorController extends BasicErrorController {

	public KnowledgeErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
