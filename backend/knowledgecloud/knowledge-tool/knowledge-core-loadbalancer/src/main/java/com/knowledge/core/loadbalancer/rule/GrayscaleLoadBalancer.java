 ...
 */
package com.knowledge.core.loadbalancer.rule;
...
import static com.knowledge.core.loadbalancer.constant.LoadBalancerConstant.VERSION_NAME;
...
public class GrayscaleLoadBalancer implements ReactorServiceInstanceLoadBalancer {
	...
	private final KnowledgeLoadBalancerProperties knowledgeLoadBalancerProperties;
	...
	private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances, Request request) {
		...
		// 指定ip则返回满足ip的服务
		List<String> priorIpPattern = knowledgeLoadBalancerProperties.getPriorIpPattern();
