...
public class ISysClientFallback implements ISysClient {
	...
	@Override
	public R<TenantVO> getTenant(Long id) {
		return null;
	}

	@Override
	public R<TenantVO> getTenant(String tenantId) {
		return null;
	}

	@Override
	public R<List<TenantVO>> getAllTenant() {
		return null;
	}

	@Override
	public R<?> registerMateData(AppInfo appInfo) {
		return null;
	}
}
