...
import com.knowledge.core.social.props.SocialProperties;
import com.knowledge.core.social.utils.SocialUtil;
...
public class SocialTokenGranter implements ITokenGranter {
	...
	public UserInfo grant(TokenParameter tokenParameter) {
		...
		// // 组装数据
		// UserOauth userOauth = Objects.requireNonNull(BeanUtil.copy(authUser,
		// UserOauth.class));
