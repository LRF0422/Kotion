    ...
    return <nav className="sticky bg-popover top-0 z-50 shadow-sm border-b">
        ...
        <div className="md:hidden hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="#features" className="block px-3 py-2 rounded-md text-base font-medium text-notion-light hover:text-notion">{t("header.feature")}</a>
                <a href="#templates" className="block px-3 py-2 rounded-md text-base font-medium text-notion-light hover:text-notion">{t("header.template")}</a>
                <a href="#testimonials" className="block px-3 py-2 rounded-md text-base font-medium text-notion-light hover:text-notion">Testimonials</a>
                <a href="#pricing" className="block px-3 py-2 rounded-md text-base font-medium text-notion-light hover:text-notion">{t("header.price")}</a>
            </div>
        </div>
    </nav>
}